<?php
    ...
    /* #Validacao do uniqueId */
        $val = null;
        $unique_Fisio = $_GET['id_usuario'];
        $sqlValId = mysqli_query($conexao, "select pa.unique_id as chavePaci, me.unique_id from tb_paciente as pa join tb_medico as me on (me.id_medico = pa.id_medico) where me.unique_id = ".$unique_Fisio." and pa.unique_id = ".$unique_id);
        ...
        <div class="content">
            ...
            <section class="chat-area">
                ...
                <?php
                    ...
                    $sql = mysqli_query($conexao, "SELECT nome, img FROM tb_medico WHERE unique_id = {$id_usuario}");
